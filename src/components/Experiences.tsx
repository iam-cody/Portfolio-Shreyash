...
const experiences = [
    {
        ...
        description: "Architected 24AV Jets Booking platform from scratch. Developed scalable Python backend services, REST APIs, and React interfaces. Managed mobile deployment workflows and maintained VPS infrastructure.",
    }
];
