        ...
        <div ref={containerRef} className="hero-container">
            ...
            <div className="fixed-text-container">
                <div className="text-container fixed-text" id="text-1">
                    <h2>Hello!, I am Shreyash</h2>
                    <p>AI/ML Engineer & Full Stack Developer. Crafting intelligent systems and scalable digital experiences.</p>
                </div>
                <div className="text-container fixed-text" id="text-2">
                    <h2>Innovation Driven</h2>
                    <p>Building production-grade platforms with deep expertise in Python, React, and sophisticated AI architectures.</p>
                </div>
                <div className="text-container fixed-text" id="text-3">
                    <h2>The Future of AI</h2>
                    <p>Leveraging Deep Learning and Agentic AI to solve real-world problems with high-impact visual fidelity.</p>
                </div>
            </div>
