...
const qualifications = [
    {
        ...
        year: "2021 - 2025",
        description: "Specializing in AI and Machine Learning. Maintaining a 7.24 CGPA and focused on production-ready AI systems.",
    ...
    },
    {
        ...
        institution: "Oracle",
        year: "2025",
        description: "Focusing on enterprise-grade AI solutions and advanced LLM deployment strategies.",
        icon: <Hexagon className="w-6 h-6" />
    },
    {
        id: 3,
        title: "Python & ML Engineering",
        institution: "GUVI & Symbiosis Skills",
        year: "2024",
        description: "Comprehensive certifications in advanced Python programming and Machine Learning model architecture.",
